...
public class elevator
{
	...
	public static ShStartPtr elevator_sh_start = new ShStartPtr() { public int handler()
	{
		pending_commands = 0;
        ...
        static int count;
	public static InterruptPtr elevator_sh_interrupt = new InterruptPtr() { public int handler()
	{
               	count++;
                if (count>=8){
                    count = 0;
