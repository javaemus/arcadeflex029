...
public class pooyan
{
        static int TIMER_RATE=36;
	public static ReadHandlerPtr pooyan_portB_r = new ReadHandlerPtr() { public int handler(int offset)
	{
		int clock;
		clock = cpu_gettotalcycles() / TIMER_RATE;
		return clock;
	} };
        public static InterruptPtr pooyan_sh_interrupt = new InterruptPtr() { public int handler()
	{
                AY8910_update();
	...
	(
		...
		new ReadHandlerPtr[] { pooyan_portB_r },
		new WriteHandlerPtr[] { null,null },
		new WriteHandlerPtr[] { null,null }
	);
        public static ShStartPtr pooyan_sh_start = new ShStartPtr() { public int handler()
	{
		pending_commands = 0;
